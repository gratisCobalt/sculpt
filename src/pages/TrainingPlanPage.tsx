            ...
            <div className="flex items-center gap-3">
              ...
              {editMode && (
                <div className="flex gap-1">
                  <Button variant="ghost" size="icon" className="h-9 w-9" onClick={() => startEditing(exercise)}>
...
export default function TrainingPlanPage() {
  ...
  const addExercise = useMutation({
    ...
    onSuccess: () => { invalidateQueries(); setShowAddExercise(false); setExerciseSearch('') },
  })
  ...
  const saveEditing = () => {
    ...
    updateExercise.mutate({
      exerciseId: editingExercise.id, sets: editingExercise.sets,
      min_reps: editingExercise.min_reps, max_reps: editingExercise.max_reps,
    })
  }
