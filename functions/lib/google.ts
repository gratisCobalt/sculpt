 ...
 */
export async function verifyGoogleIdToken(idToken: string, clientId: string): Promise<GoogleUser | null> {
  try {
    ...
    if (payload.aud !== clientId) {
      console.error('Token audience mismatch:', payload.aud, '!==', clientId)
      return null
    }
